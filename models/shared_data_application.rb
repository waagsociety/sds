...
class SharedDataApplication < CouchRest::Model::Base
  ...
  property :account, Account #creator of application
 
  property :secret, String   #application secret, generated by the system
  property :url, String	     #url to the main information website of the app
  property :redirect_url, String #redirect url for oauth proces 

  view_by :name
  view_by :account

  # Validations
  validates_presence_of     :name, :description, :url, :redirect_url
  validates_uniqueness_of   :name, :url, :redirect_url
